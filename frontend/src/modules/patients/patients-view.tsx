...
export function PatientsView() {
  ...
  return (
    <section className="space-y-5">
      ...
      {showCreateTreatment && selectedPatient ? <TreatmentCreateModal mode={treatmentMode} patient={selectedPatient} appointments={visitsQuery.data?.data ?? []} form={treatmentForm} prescriptionEnabled={prescriptionEnabled} setPrescriptionEnabled={setPrescriptionEnabled} prescription={prescription} setPrescription={setPrescription} file={treatmentFile} setFile={setTreatmentFile} mutation={treatmentMode === 'edit' ? updateTreatment : createTreatment} onAppointmentChange={selectAppointment} onClose={() => setShowCreateTreatment(false)} /> : null}
...
function TreatmentCreateModal({ mode, patient, appointments, form, prescriptionEnabled, setPrescriptionEnabled, prescription, setPrescription, file, setFile, mutation, onAppointmentChange, onClose }: { mode: 'create' | 'edit'; patient: Patient; appointments: Appointment[]; form: UseFormReturn<TreatmentValues>; prescriptionEnabled: boolean; setPrescriptionEnabled: (value: boolean) => void; prescription: PrescriptionMedicine[]; setPrescription: (items: PrescriptionMedicine[]) => void; file: File | null; setFile: (file: File | null) => void; mutation: MutationFor<TreatmentValues>; onAppointmentChange: (id: string) => void; onClose: () => void }) {
