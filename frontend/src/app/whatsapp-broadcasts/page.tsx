...
export default function WhatsAppBroadcastsPage() { return <AuthGate><AppShell><RoleGate allowed={['ADMIN']}><CommunicationCentreView initialTab="broadcasts" /></RoleGate></AppShell></AuthGate>; }
