...
export default function WhatsAppTemplatesPage() { return <AuthGate><AppShell><RoleGate allowed={['ADMIN', 'RECEPTIONIST']}><CommunicationCentreView initialTab="templates" /></RoleGate></AppShell></AuthGate>; }
