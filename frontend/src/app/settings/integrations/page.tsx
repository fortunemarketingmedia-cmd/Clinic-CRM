...
export default function IntegrationsPage() { return <AuthGate><AppShell><RoleGate allowed={['ADMIN']}><CommunicationCentreView initialTab="integration" /></RoleGate></AppShell></AuthGate>; }
